...
class Ui_FrmProd(object):
    def setupUi(self, FrmDepto):
        ...
        self.layoutWidget.setGeometry(QRect(10, 10, 371, 193))
        self.gridLayout = QGridLayout(self.layoutWidget)
        self.gridLayout.setObjectName(u"gridLayout")
        self.gridLayout.setContentsMargins(0, 0, 0, 0)
        self.spnValor = QSpinBox(self.layoutWidget)
        self.spnValor.setObjectName(u"spnValor")

        self.gridLayout.addWidget(self.spnValor, 3, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.descricaoProd, 2, 1, 1, 1)
        ...
        self.spnCategoria = QSpinBox(self.layoutWidget)
        self.spnCategoria.setObjectName(u"spnCategoria")

        self.gridLayout.addWidget(self.spnCategoria, 4, 1, 1, 1)
...
#endif // QT_CONFIG(tooltip)
        self.label.setText(QCoreApplication.translate("FrmDepto", u"N\u00famero do Produto:", None))
